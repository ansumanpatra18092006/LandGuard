...
function Notices({ onClose,returnTo }) {
  ...
  return <div className="notice-content"><p className="notice-explainer"><strong>Administrative alert inbox</strong>Rule-based operational alerts derived from recorded approvals and legal-dispute fields. These are not ML predictions.</p>
